                ...
                {isEditing ? (
                    ...
                    <>
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            Trạng thái: 
                            <span className={`ml-1 font-medium ${category.status === 'Active' ? 'text-green-600' : 'text-red-500'}`}>
                                {category.status}
                            </span>
                        </p>
                    </>
            ...
            <div className="flex flex-row sm:flex-col gap-2 shrink-0 w-full sm:w-20 mt-3 sm:mt-0">
                {isEditing ? (
                    ...
                    <>
                        ...
                        <button onClick={() => onDelete(category)} className="flex-1 sm:flex-none px-4 py-2 sm:py-1 text-sm font-bold text-red-700 transition-colors bg-red-100 hover:bg-red-200 rounded shadow-sm cursor-pointer">Xóa</button>
                    </>
                )}
            </div>
        </div>
